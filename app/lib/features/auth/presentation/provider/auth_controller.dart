...
class AuthController extends StateNotifier<AuthUIState> {
  ...
  AuthController(this._signInUseCase,this._signUpUseCase) : super(const AuthUIState());
  ...
  Future<void> login({required String email, required String password}) async {
    ...
    final result = await _signInUseCase.call(SignInWithEmailParams(email: email, password: password));
  ...
  Future<void> signup({required String email, required String password,required String displayName}) async {
    ...
    final result = await _signUpUseCase.call(SignUpWithEmailParams(email: email, password: password,displayName: displayName ));
